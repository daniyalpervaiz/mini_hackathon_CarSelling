    ...
    return (<div>
        <div className="w-full bg-blue-200 h-full 2xl:h-[80vh] flex justify-center">
            ...
            <div className="md:w-[60%] w-full ">
                <h1 className="text-black font-bold text-[18px] md:text-4xl text-center mb-4 underline">Toyota Corolla 2024 price in Pakistan,images,Reviews & Specs</h1>
                <div className="flex  items-center flex-col ">
                    <div className="w-56 h-40  ">
                        <img src="./toyotadetail.webp" alt="" /></div>
